...
- Club history — 30-entry manual dataset in `src/data/club-history.ts`, sourced from [estorilpraia.pt/historia](https://estorilpraia.pt/historia) and cross-checked against the Portuguese and English Wikipedia
